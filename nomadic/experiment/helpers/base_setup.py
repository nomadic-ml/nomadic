...
class BaseExperimentSetup(ABC):
    """Base class for experiment setup operations."""

    @abstractmethod
    def setup_tuner(self, param_dict: Dict[str, Any], param_function: Callable, **kwargs) -> Any:
        """Set up the parameter tuner with the given configuration."""
        pass
...
class DefaultExperimentSetup(BaseExperimentSetup, BaseModel):
    """Default implementation of experiment setup operations."""
