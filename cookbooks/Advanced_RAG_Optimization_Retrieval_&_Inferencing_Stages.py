...
model_name = tune.choice(["gpt-4o-mini", "gpt-4o"])
...
# If retrieval experiment already exists in Workspace, retrieve it.
# Otherwise, create a new retrieval experiment and run it.
experiment_retrieval = Experiment(
    ...
    client_id="1d9254f4-4fac-4dc3-8b2d-2a1e544d1658",
...
# If inference experiment already exists in Workspace, retrieve it.
# Otherwise, create a new retrieval experiment and run it.
experiment_inference = Experiment(
    ...
    client_id="3c1f7815-882e-4b9c-b7ed-556205396963",
    enable_logging=False,
)
